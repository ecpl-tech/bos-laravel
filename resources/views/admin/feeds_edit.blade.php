    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-title">
                <div class="row">
                    <div class="col-6">
                        <h4>Upcoming Feeds Videos/ Tips Edit</h4>
                    </div>
                    <div class="col-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route(currentUser()->role . '.feeds.update', $feed->id) }}" method="post"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select btn-square" name="course">
                                                    ...
                                                    <option value="all"
                                                        {{ old('course', $feed->course) == 'all' ? 'selected' : '' }}>
                                                        All
                                                    </option>
                                                    <option value="foundation"
                                                        {{ old('course', $feed->course) == 'foundation' ? 'selected' : '' }}>
                                                        Foundation
                                                    </option>
                                                    <option value="intermediate"
                                                        {{ old('course', $feed->course) == 'intermediate' ? 'selected' : '' }}>
                                                        Intermediate
                                                    </option>
                                                    <option value="final"
                                                        {{ old('course', $feed->course) == 'final' ? 'selected' : '' }}>
                                                        Final</option>
                                                </select>
                                                @error('course')
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-check radio radio-success mb-0 mt-1">
                                                            <input class="form-check-input" id="Education" type="radio"
                                                                ...
                                                                {{ old('category', $feed->category) == 'education' ? 'checked' : '' }}
                                                                checked>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-check radio radio-success mb-0 mt-1">
                                                            <input class="form-check-input" id="Other" type="radio"
                                                                ...
                                                                {{ old('category', $feed->category) == 'other' ? 'checked' : '' }}>
                                                            <label class="form-check-label mb-0 px-1"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-check radio radio-success mb-0 mt-1">
                                                            <input class="form-check-input" id="Video" type="radio"
                                                                ...
                                                                {{ old('type', $feed->type) == 'video' ? 'checked' : '' }}>
                                                            <label class="form-check-label mb-0 px-1"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-check radio radio-success mb-0 mt-1">
                                                            <input class="form-check-input" id="file" type="radio"
                                                                ...
                                                                {{ old('type', $feed->type) == 'file' ? 'checked' : '' }}>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input class="form-control btn-square" type="text"
                                                            ...
                                                            value="{{ old('video_id', $feed->type == 'video' ? $feed->file_name : '') }}">
                                                        @error('video_id')
                                                            <span class="text-danger f-w-500">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="col-sm-12" id="Inputpdf">
                                            <div class="mb-3">
                                                ...
                                                <span class="text-muted f-w-500">Only MP4 format allowed. Max file size: 20
                                                    MB</span><br>
                                                @if ($feed->file_name && $feed->type == 'file')
                                                    <span class="text-info f-w-500">Current File:
                                                        {{ $feed->file_name }}</span>
                                                @endif
                                                @error('file')
                                                    <span class="text-danger f-w-500">{{ $message }}</span>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control btn-square" type="text" placeholder="Title"
                                                    name="title" value="{{ old('title', $feed->title) }}">
                                                @error('title')
                                                    <span class="text-danger f-w-500">{{ $message }}</span>
                                                @enderror
                                            </div>
