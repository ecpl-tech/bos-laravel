                    ...
                    <div class="card-body">
                        <div class="form theme-form">
                            <div class="row">
                                ...
                                <div class="col-sm-6" id="FoundationPaper">
                                    <div class="mb-3">
                                        <label>Paper :</label>
                                        <select class="form-select btn-square" name="paper">
                                            <option value="">-- Select Paper --</option>
                                ...
                                <div class="col-sm-6" id="IntermediatePaper">
                                    <div class="mb-3">
                                        <label>Paper :</label>
                                        <select class="form-select btn-square" name="paper">
                                            <option value="">-- Select Paper --</option>
                                ...
                                <div class="col-sm-6" id="FinalPaper">
                                    <div class="mb-3">
                                        <label>Paper :</label>
                                        <select class="form-select btn-square" name="paper">
                                            <option value="">-- Select Paper --</option>
                                ...
                                <div class="col-sm-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control btn-square" type="text"
                                            placeholder="Joining Link" name="joining_link:">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
