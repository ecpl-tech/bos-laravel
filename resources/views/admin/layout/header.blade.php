                ...
                <div class="header-wrapper row m-0">
                    ...
                    <div class="header-logo-wrapper col-auto p-0">
                        <div class="logo-wrapper">
                            <a href="{{ route(currentUser()->role.'.dashboard') }}">
                    ...
                    <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
                        <div>
                            ...
                            <div class="d-flex align-items-center gap-2 ">
                                <h4 class="f-w-600">Welcome {{ currentUser()->name }}</h4><img class="mt-0"
                        ...
                        <ul class="nav-menus">
                            ...
                            <li class="profile-nav onhover-dropdown">
                                ...
                                <div class="media profile-media"><img class="b-r-20"
                                        ...
                                        alt="">
                                    <div class="media-body d-xxl-block d-none box-col-none">
                                        <div class="d-flex align-items-center gap-2"> <span>{{ currentUser()->name ?? '' }} </span><i
                                                class="middle fa fa-angle-down"> </i></div>
                                        <p class="mb-0 font-roboto">{{ ucfirst(currentUser()->role) }}</p>
                                    </div>
                                </div>
                            ...
                            <div id="sidebar-menu">
                                <ul class="sidebar-links" id="simple-bar">
                                    ...
                                    <li class="sidebar-list"><i class="fa fa-thumb-tack"> </i><a
                                            ...
                                            href="{{ route(currentUser()->role.'.dashboard') }}">
                                    ...
                                    <li class="sidebar-list"><i class="fa fa-thumb-tack"></i>
                                        <a class="sidebar-link sidebar-title" href="#">
                                            <svg class="stroke-icon">
                                                <use href="{{ URL::asset('assets/svg/icon-sprite.svg#stroke-user') }}"></use>
                                            </svg>
                                            <svg class="fill-icon">
                                                <use href="{{ URL::asset('assets/svg/icon-sprite.svg#fill-user') }}"></use>
                                            </svg>
                                            <span>User Management</span>
                                        </a>
                                        <ul class="sidebar-submenu">
                                            <li><a href="{{ route(currentUser()->role.'.user.list') }}">List</a></li>
                                            <li><a href="{{ route(currentUser()->role.'.user.add') }}">Add</a></li>
                                        </ul>
                                    </li>
                                ...
                                <ul class="sidebar-links" id="simple-bar">
                                    ...
                                    <li class="sidebar-list"><i class="fa fa-thumb-tack"></i>
                                        <a class="sidebar-link sidebar-title" href="#">
                                            ...
                                            <span>LVC Questions</span>
                                        </a>
                                        <ul class="sidebar-submenu">
                                            <li><a href="pdf_list.php">Foundation</a></li>
                                            <li><a href="pdf_list.php">Intermediate</a></li>
                                            <li><a href="pdf_list.php">Final</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="sidebar-list"><i class="fa fa-thumb-tack"></i>
                                        <a class="sidebar-link sidebar-title" href="#">
                                            ...
                                            <span>LVC Notes & Assignments</span>
                                        </a>
                                        <ul class="sidebar-submenu">
                                            <li><a href="pdf_list.php">List</a></li>
                                            <li><a href="pdf_add.php">Add</a></li>
                                    ...
                                    <li class="sidebar-list"><i class="fa fa-thumb-tack"></i>
                                        <a class="sidebar-link sidebar-title" href="#">
                                            ...
                                            <span>LVRC Notes & Assignments</span>
                                        </a>
                                        <ul class="sidebar-submenu">
                                            <li><a href="pdf_list.php">List</a></li>
                                            <li><a href="pdf_add.php">Add</a></li>
