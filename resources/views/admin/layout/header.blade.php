                        ...
                        <div id="sidebar-menu">
                            <ul class="sidebar-links" id="simple-bar">
                                <li class="back-btn">
                                    <a href="{{ route(currentUser()->role . '.dashboard') }}">
                                        <img class="img-fluid"
                                            src="{{ URL::asset('assets/images/logo/logo-icon.png') }}"
                                            alt="">
                                    </a>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i>
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li><a href="{{ route(currentUser()->role . '.pou_user.index') }}">List</a>
                                        </li>
                                        <li><a href="{{ route(currentUser()->role . '.pou_user.create') }}">Add</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i>
